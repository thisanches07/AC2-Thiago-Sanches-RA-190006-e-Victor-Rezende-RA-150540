...
public class PlaceController {
  ...
  @PostMapping
  public ResponseEntity<PlaceDTO> salvar(@Valid @RequestBody PlaceInsertDTO placeDTO) {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<PlaceDTO> update(@Valid @RequestBody PlaceUpdateDTO placeUpdateDTO,
