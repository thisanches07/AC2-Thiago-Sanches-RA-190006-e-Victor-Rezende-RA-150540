...
INSERT INTO tb_event (name,description,start_date,end_date,start_time,end_time,email_contact,amount_free_tickets,amount_payed_tickets,price_ticket,admin_id) VALUES ('Abril Fest','descricao do Abril Fest','2021-04-10','2021-11-11','00:00','22:22','email',20,200,2,1);
INSERT INTO tb_event (name,description,start_date,end_date,start_time,end_time,email_contact,amount_free_tickets,amount_payed_tickets,price_ticket,admin_id) VALUES ('October Fest','descricao do October Fest','2021-10-11','2021-10-15','00:00','22:22','email',40,400,1.5,2);
INSERT INTO tb_event (name,description,start_date,end_date,start_time,end_time,email_contact,amount_free_tickets,amount_payed_tickets,price_ticket,admin_id) VALUES ('Festa da Facens','descricao do Abril Fest','2021-01-11','2021-01-12','00:00','22:22','email',100,200,1,3);
